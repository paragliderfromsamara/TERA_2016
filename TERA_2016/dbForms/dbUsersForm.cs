...
namespace TERA_2016
{
    public partial class dbUsersForm : Form
    {
        ...
        private DBControl mysql = new DBControl(dbSettings.Default.dbName);
       ...
       private void initRolesList()
        {
            string com = dbSettings.Default.selectRoles;
        ...
        private void initUserList()
        {
            usersDataSet.Reset();
            mysql.MyConn.Open();
            string com = dbSettings.Default.selectActiveUsersJoinedRoles;
            MySqlDataAdapter da = new MySqlDataAdapter(com, mysql.MyConn);
        ...
        {
            string com = dbSettings.Default.insertUser;
            if (checkForm(false))
            {
        ...
        private void delUserToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (usersList.SelectedRows.Count > 0)
            {
                ...
                string com = dbSettings.Default.hideUsers;
        ...
        private void saveUserData_Click(object sender, EventArgs e)
        {
            ...
            if (!checkForm(true))
            {
                ...
                {
                    com = dbSettings.Default.updateUserWithoutPassword;
                ...
                {
                    com = dbSettings.Default.updateUserWithPassword;
